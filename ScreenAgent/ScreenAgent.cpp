...
// ScreenAgent.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CScreenAgentApp, CWinApp)
...
CScreenAgentApp::CScreenAgentApp()
{
	// 다시 시작 관리자 지원
...
// 유일한 CScreenAgentApp 개체입니다.

CScreenAgentApp theApp;


// CScreenAgentApp 초기화

BOOL CScreenAgentApp::InitInstance()
{
	...
	SetRegistryKey(_T("Wowsoft"));

	CScreenAgentDlg dlg1;
	//CSettingDlg dlg;
	m_pMainWnd = &dlg1;
...
*/
	...
	//WriteProfileInt(_T("Screen"), _T("LineCount"), dlg.LineCount);
	//WriteProfileInt(_T("Screen"), _T("RectCount"), dlg.RectCount);

	//WriteProfileString(_T("Screen"), _T("Text"), dlg.str);
	//WriteProfileString(_T("Screen"), _T("FontStyle"), dlg.fontStyle);
	//WriteProfileInt(_T("Screen"), _T("FontSize"), dlg.FontSize);

	//WriteProfileInt(_T("Screen"), _T("Degree"), dlg.degree);

	//WriteProfileInt(_T("Screen"), _T("Color_R"), dlg.color_r);
	//WriteProfileInt(_T("Screen"), _T("Color_G"), dlg.color_g);
	//WriteProfileInt(_T("Screen"), _T("Color_B"), dlg.color_b);


	//WriteProfileInt(_T("Screen"), _T("Outline_R"), dlg.Outline_r);
	//WriteProfileInt(_T("Screen"), _T("Outline_G"), dlg.Outline_g);
	//WriteProfileInt(_T("Screen"), _T("Outline_B"), dlg.Outline_b);
